...
function StatsDClient(options) {
    ...
    if (this.options.socket) {
        ...
        // Ephemeral socket
        this._socket = this.options._socket || new EphemeralSocket(options);
    }
}
...
/*
 * Encapsulates all socket sending
 */
StatsDClient.prototype.send = function (type, name, value) {
    this._socket.send(this.options.prefix + name + ":" + value + "|" + type);
};
