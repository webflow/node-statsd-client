 ...
 * Send data.
 */
ephemeralSocket.prototype._writeToSocket = function _writeToSocket(buf, cb) {
...
ephemeralSocket.prototype._socketSend = function _socketSend(host, buf, cb) {
    var self = this;
    ...
    if (cb) {
        ...
        self._socket.send(buf, 0, buf.length, self._port, host);
    }
};
